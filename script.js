...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const searchableContent = [
    { title: 'اندیشه و نظریه', text: 'مبانی فکری، انسان‌شناسی، فلسفه اجتماعی و نظریه‌های تمدنی', link: '#thought', category: 'محورهای محتوایی' },
    { title: 'فرهنگ و جامعه', text: 'تحلیل فرهنگ، هویت، خانواده، آموزش، رسانه و تحولات اجتماعی', link: '#society', category: 'محورهای محتوایی' },
    { title: 'علم و فناوری', text: 'نسبت علم، فناوری، نوآوری و قدرت تمدنی در جهان معاصر', link: '#science', category: 'محورهای محتوایی' },
    { title: 'اقتصاد و پیشرفت', text: 'اقتصاد، تولید، عدالت، حکمرانی اقتصادی و الگوهای پیشرفت', link: '#economy', category: 'محورهای محتوایی' },
    { title: 'حکمرانی و سیاست', text: 'نهادها، سیاست‌گذاری، حکمرانی و ظرفیت‌های دولت و جامعه', link: '#governance', category: 'محورهای محتوایی' },
    { title: 'راهبرد و آینده', text: 'سناریوها، روندها، مسائل راهبردی و طراحی مسیرهای آینده‌نگر', link: '#strategy', category: 'محورهای محتوایی' },
    { title: 'فاز ۱: بنیادهای نظری و فلسفی', text: 'تدوین درسنامه‌های انسان‌شناسی و هستی‌شناسی تمدنی', link: '#roadmap', category: 'نقشه راه جامع' },
    { title: 'فاز ۲: هسته‌های پژوهشی و تحلیل مسائل', text: 'نگاشت مسائل کلان حکمرانی، عدالت و اقتصاد دانش‌بنیان', link: '#roadmap', category: 'نقشه راه جامع' },
    { title: 'فاز ۳: تولید و انتشار منابع رسانه‌ای', text: 'انتشار کتاب، مجلات تخصصی، پادکست‌ها و درسگفتارهای تصویری', link: '#roadmap', category: 'نقشه راه جامع' },
    { title: 'فاز ۴: شبکه‌سازی و ارتقاء نهادی', text: 'توسعه پلتفرم تعاملی اندیشکده و ارائه توصیه‌نامه‌های سیاست‌پژوهی', link: '#roadmap', category: 'نقشه راه جامع' },
    { title: 'ارتقاء و توسعه وبسایت', text: 'داشبورد هوشمند پیشرفت پلتفرم و قابلیت ارتقاء قابلیت‌های اندیشکده', link: '#upgrade-center', category: 'سامانه ارتقاء' }
  ];
  ...
  if (searchInput && searchResults) {
    searchInput.addEventListener('input', (e) => {
      ...
      if (!query) {
        searchResults.innerHTML = '<div class="search-empty">عبارت مورد نظر خود را تایپ کنید...</div>';
        return;
      }
  ...
  function updateUpgradeStats() {
    ...
    if (totalMilestoneCount) totalMilestoneCount.textContent = `${completed} از ${total} گام تکمیل شده`;
  }
